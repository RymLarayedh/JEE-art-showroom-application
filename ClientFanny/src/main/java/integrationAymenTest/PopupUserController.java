...
public class PopupUserController implements Initializable {
	...
	public void initialize(URL url, ResourceBundle rb) {
		...
		if (UserManagmentDelegate.getAllFollowed(LoginController.userLogedIn).contains(userChoosen)) {
	...
	private void FollowUnfollowUser(ActionEvent event) {
		if (FollowUnfollow.getText().equals("Follow")) {
			UserManagmentDelegate.addFollower(LoginController.userLogedIn, userChoosen);
			FollowUnfollow.setText("UnFollow");

		} else {
			UserManagmentDelegate.removeFollower(LoginController.userLogedIn, userChoosen);
			FollowUnfollow.setText("Follow");
		}
	}
